      ...
      >
        <Zap
          className={clsx(
            ...
            "stroke-[color:var(--ui-anim-svg-fill)]",
            "transition-[stroke,filter,opacity] duration-400"
          )}
          aria-hidden="true"
        />
        <div className="ui-anim-txt-wrapper relative flex min-w-[7.5em] items-center">
          <div
            className={clsx(
